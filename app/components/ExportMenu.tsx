  ...
  const renderButtons = (isMobile: boolean) => (
    <div ref={!isMobile ? menuRef : undefined} className={`relative gap-2 ${isMobile ? "flex w-full" : "inline-flex"}`}>
      <button
        ...
        className={`inline-flex items-center justify-center gap-1.5 rounded-md px-3 text-xs font-medium transition-colors disabled:opacity-40 ${
          isMobile
            ? "flex-1 bg-gray-900 py-2.5 text-white hover:bg-gray-800 disabled:hover:bg-gray-900"
            : "bg-gray-100 py-1.5 text-gray-500 hover:bg-gray-200 disabled:hover:bg-gray-100"
        }`}
      >
      ...
      <a
        ...
        className={`inline-flex items-center justify-center gap-1.5 rounded-md px-3 text-xs font-medium transition-colors ${
          isMobile
            ? "flex-1 bg-gray-900 py-2.5 text-white hover:bg-gray-800"
            : "bg-gray-100 py-1.5 text-gray-500 hover:bg-gray-200"
        }`}
      >
